...
export default function MapRun() {
    ...
    return (
        <View style={styles.container}>
            ...
            <Avatar.Image style={{backgroundColor:'#FFF'}} size={40} source={require('../assets/marker.png')} />
                <View>
                    <Text style={{fontWeight:'900', fontSize:20, marginLeft:20, color:'#000'}}>John Doe</Text>
                    <Text style={{fontWeight:'bold', marginLeft:20, color:'#000'}}>Davis St</Text>
                </View>
                <View>
                <Text style={{fontWeight:'bold',fontSize:30, marginLeft:150, textAlign:'right', right:20, color:'#000'}}>{eta.toFixed(0)} mins</Text>
                <Text style={{fontWeight:'900',fontSize:30, marginLeft:40,textAlign:'right', right:20, color:'#000'}}>1: 10 PM Arrival</Text>
                </View>
            </View>
            </View>
            ...
            <Text style={{color:'#000000', fontSize:20, fontWeight:'bold', textAlign:'center', textAlignVertical:'top', alignSelf:'center'}}>John Doe is almost there!</Text>
